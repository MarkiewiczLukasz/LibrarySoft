...
extern char ListStoredBooksFileName[];
extern char ListBorrowedBooksFileName[];
extern char ListLibraryUsersFileName[];

StoredBook ListStoredBooks[100];
BorrowedBook ListBorrowedBooks[100];
LibraryUser ListLibraryUsers[100];
